...
public class StockDetailActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.e("stock", "StockDetailActivity codenum : " + code);
		...
		mWebview.setWebViewClient(new WebViewClient() {
			public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
				Toast.makeText(StockDetailActivity.this, "error " + description, Toast.LENGTH_SHORT).show();
			}
		});
		url = addr + code.trim() +"/total";
		mWebview.loadUrl(url.trim());
		Log.e("stock", "StockDetailActivity addr + code : " + (url.trim()));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.delete) {
			if (code != null) {
				...
				new AlertDialog.Builder(this).setTitle("종목 삭제").setMessage("선택한 종목을 삭제 하시겠습니까?")
